# Kích Hoạt Quy Trình Rà Soát Chất Lượng & Bảo Mật Codebase (AI Code Audit Trigger)
...
1. **Database Schema:** [schema.prisma](file:///e:/FOOD_AI_code/my-web/backend/prisma/schema.prisma) để kiểm tra các Enums, quan hệ và kiểu dữ liệu.
2. **Cấu hình dự án:**
   - [next.config.ts](file:///e:/FOOD_AI_code/my-web/frontend/next.config.ts) (Kiểm tra Hostname Whitelist).
   - [package.json](file:///e:/FOOD_AI_code/my-web/frontend/package.json) và [package.json](file:///e:/FOOD_AI_code/my-web/backend/package.json) (Kiểm tra các phiên bản thư viện dùng).
3. **Lớp bảo mật & Base components:**
   - [SafeImage.tsx](file:///e:/FOOD_AI_code/my-web/frontend/src/components/base/SafeImage.tsx)
...
Dựa theo tiêu chí trong [.check-prompt/Prompt để AI chấm điểm codebase.txt](file:///e:/FOOD_AI_code/.check-prompt/Prompt%20để%20AI%20chấm%20điểm%20codebase.txt), hãy chấm điểm dự án trên thang điểm 10 ở các mặt:
